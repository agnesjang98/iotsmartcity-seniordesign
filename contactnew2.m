...
a=a1+a2;
rou=32840;
velocity=80*1000/3600; % the speed of the car T=(l+a)/velocity;
dt=0.000001*T;
t=0:dt:T; 
...
a=a1+a2;
rou=32840;
velocity=120*1000/3600; % the speed of the car T=(l+a)/velocity;
dt=0.000001*T;
t=0:dt:T; 
...
a=a1+a2;
rou=32840;
velocity=160*1000/3600; % the speed of the car T=(l+a)/velocity;
dt=0.000001*T;
t=0:dt:T; 
